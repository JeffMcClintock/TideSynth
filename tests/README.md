...
TIDE ships **five** rack prefabs (`SE16/TideModules/prefabs/`, generated by
`build-prefabs.py`). Three have a case here; two cannot, and the reasons are
measured rather than assumed — recorded so nobody spends a session rediscovering
them (BACKLOG **E13**, 2026-08-19, macos).
